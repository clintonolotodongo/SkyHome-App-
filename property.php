                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">UGX <?php echo number_format($row['price'],2);?> <b><s style="color:yellow;">UGX <?php echo number_format($addprice,2);?></s></b><span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
