                ...
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="text-success text-left h5 my-2 text-md-right">UGX <?php echo number_format($row['13'],2);?></div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <form class="d-inline-block w-100" action="calc" method="post">
                        ...
                        <ul class="property_list_widget">
                            ...
                            <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                <h6 class="text-secondary hover-text-success text-capitalize"><a href="propertydetail?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h6>
