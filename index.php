                        ...
                        <div class="text-white">
                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" type="text" name="city" id="">
                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-sm btn-success w-100">Search Property</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>UGX <?php echo number_format($row['price'],2);?> </b><s style="color:yellow;"><b>UGX <?php echo number_format($addprice,2);?> </b></s><span class="text-white"><?php echo $row['12'];?> Sqft</span>
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="propertydetail?pid=<?php echo $row['0'];?>"><img src="click.png" style="width:30px;" alt=""><?php echo $row['title'];?></a></h5>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We are the best in service delivery as per realising your dream home and land is concern.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We have provided solutions to many people especially in lira City.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We have professional brokers who knows how to handle customers.</p>
									</div>
                                </li>
                            </ul>
                        </div>
